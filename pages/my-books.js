  ...
  return (
    <>
      ...
      <div className="mx-24">
        ...
        <p>I've written a collection of short stories and wasn't satisfied with it so I began to think of what else to do.</p>
        <p>This is currently a work in progress (I'm also making a web app for the book).</p>
        <br />
        <p>The stories are written as literary fiction and rather dark in their themes and content.</p>
